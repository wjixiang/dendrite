...
pub fn registrations(svc: Arc<kms::KmsService>) -> Vec<tools::ToolRegistration> {
    vec![
...
fn create_entity(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
...
fn update_entity(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_update_entity",
...
fn list_entities(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_list_entities",
...
fn delete_entity(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_delete_entity",
...
fn add_nomenclature(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn update_nomenclature(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn delete_nomenclature(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn get_entity(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
...
fn search_entity(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
...
fn get_entity_knowledge(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn get_knowledge(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_get_knowledge",
...
fn create_knowledge(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn create_index(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_create_index",
...
fn navigate_index(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_navigate",
...
fn reorganize_children(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn move_index(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_move_index",
...
fn link_orphans(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_link_orphans",
...
fn update_knowledge(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn rename_knowledge(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn delete_knowledge(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
...
fn delete_index(svc: Arc<kms::KmsService>) -> tools::ToolRegistration {
    let definition = ToolBuilder::new(
        "kms_delete_index",
