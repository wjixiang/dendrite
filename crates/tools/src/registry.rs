...
use crate::error::{ToolError, ToolOperationResult};
use crate::function::ToolFunction;
use types::{Tool, ToolResult, ToolUse};
...
impl ToolRegistry {
    ...
    /// # Example
    /// ```rust
    /// use tools::{ToolRegistry, ToolFunction};
    /// use tools::{ToolBuilder, ToolResult};
...
mod tests {
    use super::*;
    use crate::{ToolBuilder, ToolFunction, ToolResultContent};
    use async_trait::async_trait;
    use serde_json::json;
